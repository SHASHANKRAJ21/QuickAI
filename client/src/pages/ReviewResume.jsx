...
const [loading, setLoading] = useState(false);
  ...
  return (
    ...
    >
      ...
      bg-gradient-to-r from-[#00DA83] to-[#009BB3] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer"
        >
        {
    ...
    border border-gray-200 min-h-96 max-h-[600px]"
      >
        <div className="flex items-center gap-3">
          <FileText className="w-5 h-5 text-[#00DA83]"></FileText>
...

        {
          ...
          <div className="text-sm flex flex-col items-center gap-5 text-gray-400">
            <FileText className="w-9 h-9"></FileText>
            <p>Upload an Resume and click "Review Resume" to get started</p>
          </div>
        </div> 
          ):(
            <div className="mt-3 h-fu;; overflow-y-scroll text-sm text-slate-600">
