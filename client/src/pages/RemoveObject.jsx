  ...
  return (
    ...
    >
      ...
      text-sm rounded-md border border-gray-300 text-gray-600"
          required
        ></input>
        <p className="mt-6 text-sm font-medium">Describe object naem to remove</p>
        <textarea
...
"
      ...
      bg-gradient-to-r from-[#417DF6] to-[#8E37EB] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer"
        >
        {
